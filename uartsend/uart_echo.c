...
// Para probar este programa, se puede usar PuTTY o la terminal de Energia.
// ----------------------------------------------------------------------------
...
int main(void)
{
    ...
    //
    GPIOPinConfigure(GPIO_PA0_U0RX); // GPIO_PA0_U0RX   0x00000001
    GPIOPinConfigure(GPIO_PA1_U0TX); // GPIO_PA1_U0TX   0x00000401
